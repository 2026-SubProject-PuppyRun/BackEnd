...
API 추가 또는 변경이 포함된 PR의 요청·응답 및 테스트 시나리오는 [API 명세서 작성 규칙](api-spec.md)을 함께 적용합니다. PR 템플릿의 섹션 구조는 유지하고, Method, URL, Content-Type, Header, 요청·응답 예시와 발생 가능한 오류를 실제 코드에 맞게 작성합니다.
